...
@ComponentConfig(
        ...
        template = "classpath:groovy/ecm/social-integration/share-document/UIUserInvitation.gtmpl"
        /*events = {
                @EventConfig(listeners = UIUserInvitation.AddActionListener.class)
        }*/
)
public class UIUserInvitation extends UIForm {
    ...
    *//**
     ...
     * @author hoatle
     *//*
    static public class AddActionListener extends EventListener<UIUserInvitation> {
