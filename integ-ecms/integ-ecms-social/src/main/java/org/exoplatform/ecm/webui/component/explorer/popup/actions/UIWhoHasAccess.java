...
@ComponentConfig(
        ...
        events = {
                @EventConfig(listeners = UIWhoHasAccess.PermissionChangeActionListener.class)
        }
)
...
//                    .addScripts("eXo.ecm.ShareContent.checkSelectedSpace('"+uiform.spaces+"');");
    ...
    public void getIdentityName(String identity) {
        try {
            UIContainer parentContainer = createUIComponent(UIContainer.class, null, null);
            ...
            UIFormSelectBox uiFormSelectBox = new UIFormSelectBox("identityPermission", "identityPermission", permOption);
            parentContainer.addChild(uiFormSelectBox);
            uiFormSelectBox.setOptions(itemOptions);
            uiFormSelectBox.setLabel(identity);
            uiFormSelectBox.setValue(getPermission(identity));
            parentContainer.renderChild("identityPermission");
        } catch (Exception e) {
