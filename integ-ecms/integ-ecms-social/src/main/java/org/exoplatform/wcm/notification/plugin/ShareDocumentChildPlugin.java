...
public class ShareDocumentChildPlugin extends AbstractNotificationChildPlugin {
    ...
    public ShareDocumentChildPlugin(InitParams initParams) {
        super(initParams);
    }
...
//            ActivityManager activityM = CommonsUtils.getService(ActivityManager.class);
            ...
            templateContext.put("DOCUMENT_URL", LinkProviderUtils.getRedirectUrl(ACTIVITY_URL, activity.getId()));
